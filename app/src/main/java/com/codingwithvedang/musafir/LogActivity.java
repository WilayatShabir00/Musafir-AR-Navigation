...
import com.codingwithvedang.musafir.datacollection.WifiFingerprintList;
import com.codingwithvedang.musafir.indoorLocation.SecurityProvider;
        ...
        loginButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    client.setSSLSocketFactory(SecurityProvider.getSocketFactory(LogActivity.this));
                            ...
                            ent, "application/json", new JsonHttpResponseHandler() {
                                ...
                                public void onSuccess(int statusCode, Header[] headers, JSONObject responseBody) {
                                    try {
                                        ...
                                        Toast.makeText(LogActivity.this,"Server sent weird response",Toast.LENGTH_LONG);
                                    }
                                }
                            });
                    ...
                    Toast.makeText(LogActivity.this, "error processing the input", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
